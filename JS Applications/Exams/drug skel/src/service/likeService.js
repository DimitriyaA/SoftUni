...
const endPoints = {
    addLike: '/data/likes',
    likesById: (itemId) => `/data/likes?where=solutionId%3D%22${itemId}%22&distinct=_ownerId&count`,
    likesByUser: (itemId, userId) => `/data/likes?where=solutionId%3D%22${itemId}%22%20and%20_ownerId%3D%22${userId}%22&count`
}
